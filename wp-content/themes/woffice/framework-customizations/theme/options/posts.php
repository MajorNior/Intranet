...
$email_notification_attr = array();
	if(class_exists('WOAE_Utils')) {
		...
		$notice_text = __('Dynamic variables that will be replaced automatically: {user_name}, {project_info}..This field is deactivated after purchasing Woffice Advanced Emails. You can created your template <a href="'. admin_url("admin.php?page=woae_advanced_email_templates").'">here</a>', 'woffice');
	}
/* End */
