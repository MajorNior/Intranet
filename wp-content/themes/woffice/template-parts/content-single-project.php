		...
		<div class="item-list-tabs-project">
			...
			<?php
				...
				<?php	
						...
						_e('You have purchased this project with '. $price_html .'','woffice');
					} else if($is_purchasable && $is_subscription_enabled && $is_subscirbed == 'active' || $assigned_project_members){
						_e('Subscription is enabled for this project with '. $price_html .'','woffice');
					} else if($is_purchasable && $is_subscription_enabled && $is_subscirbed == 'active'){
						_e('Your subscription for this project with '. $price_html .' is ' . $is_subscirbed.'','woffice');
